...
alias docker-postgres='function _dockerPostgres() { docker run --name postgres_container -e POSTGRES_DB=$1 -e POSTGRES_USER=postgres -e POSTGRES_PASSWORD=postgres -e POSTGRES_DB=$1 -p 5432:5432 postgres; }; _dockerPostgres'
alias docker-pgadmin='docker run --name pgadmin_container -e PGADMIN_DEFAULT_EMAIL=admin -e PGADMIN_DEFAULT_PASSWORD=admin -p 8081:80 dpage/pgadmin4'
alias docker-doomsday-clock='docker-stop-containers; docker-rm-containers'
alias docker-internal-host='echo host.docker.internal'
